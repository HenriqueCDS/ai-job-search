...
\begin{itemize}
    ...
    \item Desenvolvo automações em Python integradas à API REST do Canvas para criação de salas, sincronização de matrículas e auditoria de acessos, reduzindo em 60\% o tempo de rotinas operacionais manuais
...
% --- Previous Role ---
\needspace{5\baselineskip}
\item{\cventry{mar/2022--mar/2024}{Estagiário em Desenvolvimento de Software}{FUNCAMP}{Campinas, SP}{}{\vspace{1pt}
\begin{itemize}
    ...
    \item Customizei módulos e fluxos da plataforma open source SIGA DOC para adequar o sistema de gestão documental da Prefeitura de São José do Rio Preto às regras do órgão
\end{itemize}}}
...
\needspace{4\baselineskip}
\item{\cventry{fev/2022--jun/2024}{Tecnólogo em Análise e Desenvolvimento de Sistemas}{Centro Universitário UniMetrocamp Wyden}{Campinas, SP}{}{\vspace{1pt}
Concluído.
}}
